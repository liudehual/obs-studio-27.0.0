	...
	: QWidget(parent), ui(new Ui::MediaControls)
{
	...
	connect(&mediaTimer, SIGNAL(timeout()), this,SLOT(SetSliderPosition()));
	connect(&seekTimer, SIGNAL(timeout()), this, SLOT(SeekTimerCallback()));
	connect(ui->slider, SIGNAL(sliderPressed()), this,SLOT(MediaSliderClicked()));
	connect(ui->slider, SIGNAL(mediaSliderHovered(int)), this,SLOT(MediaSliderHovered(int)));
	connect(ui->slider, SIGNAL(sliderReleased()), this,SLOT(MediaSliderReleased()));
	connect(ui->slider, SIGNAL(sliderMoved(int)), this,SLOT(MediaSliderMoved(int)));
	...
	connect(sliderFoward, SIGNAL(triggered()), this,SLOT(MoveSliderFoward()));
	...
	connect(sliderBack, SIGNAL(triggered()), this,SLOT(MoveSliderBackwards()));
