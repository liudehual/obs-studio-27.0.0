...
EXPORT struct winrt_capture *winrt_capture_init_window(BOOL cursor, HWND window,BOOL client_area);
...
EXPORT void winrt_capture_show_cursor(struct winrt_capture *capture,BOOL visible);
EXPORT void winrt_capture_render(struct winrt_capture *capture,gs_effect_t *effect);
